	...
	def blockMeshDict_func(int_lng, parn, tab, spe_edit, spp_edit, mpp_edit, prj_path, mesh_name_txt, bmd_par): 
		def blockMeshDict_end(int_lng, prj_path, parn):
			...
			if int_lng == 'Russian':
				...
				msg = "The 'blockMeshDict' file saved"
		...
		if os.path.exists(blocks_1_path):	
			...
			if int_lng == 'Russian':
				...
				msg = "Fill out the 'blocks_1' form"
			msg_list.append(msg)
		...
		if os.path.exists(blocks_2_path):	
			...
			if int_lng == 'Russian':
				...
				msg = "Fill out the 'blocks_2' form"
			msg_list.append(msg)
		...
		if spp_edit.isChecked() == True:
			...
			if os.path.exists(patches_1_path):	
				...
				if int_lng == 'Russian':
					...
					msg = "Fill out the 'patches_1' form"
				msg_list.append(msg)
			...
			if os.path.exists(patches_2_path):	
				...
				if int_lng == 'Russian':
					...
					msg = "Fill out the 'patches_2' form"
				msg_list.append(msg)
		...
		if mpp_edit.isChecked() == True:
			...
			if os.path.exists(mergepatchpairs_path):	
				...
				if int_lng == 'Russian':
					...
					msg = "Fill out the 'mergepatchpairs' form"
				msg_list.append(msg)
