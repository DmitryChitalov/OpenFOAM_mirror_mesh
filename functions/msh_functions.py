...
class msh_functions_class():		
	...
	###..............................Функция при старте генерации сетки..........................### 
	
	def on_msh_start(prj_path_val_th, mesh_name_txt_val_th, par, int_lng, msh_t):

		if int_lng == 'Russian':
			msg_lbl = QLabel('<span style="color:blue">' + "Выполняется генерация РС" + '</span>')
		elif int_lng == 'English':
			msg_lbl = QLabel('<span style="color:blue">' + "Mesh generation making" + '</span>')
	...
	###..............................Функция при завершении генерации сетки..........................### 
	...
	def on_msh_finished(return_code, prj_path_val_th, mesh_name_txt_val_th, par, int_lng, msh_t):
		...
		if int_lng == 'Russian':
			par.outf_lbl.setText('Результаты генерации сетки типа ' + '<span style="color:green">' + msh_t + '</span>') 
		elif int_lng == 'English':
			par.outf_lbl.setText('Generation results of mesh of type ' + '<span style="color:green">' + msh_t + '</span>') 
		...
		if return_code == 0:
			if int_lng == 'Russian':
				...
				msg_lbl = QLabel('<span style="color:green">' + "Mesh of type " + msh_t + " successfully generated" + '</span>')
			color = QtGui.QColor("green")
			
			par.msh_visual.setEnabled(True)
			par.solv_run.setEnabled(True)

		else:
			if int_lng == 'Russian':
				msg_lbl = QLabel('<span style="color:red">' + "Расчетная сетка типа " + msh_t + " сгенерирована c ошибками" + '</span>')
			elif int_lng == 'English':
				msg_lbl = QLabel('<span style="color:red">' + "Mesh of type " + msh_t + " generated with errors" + '</span>')
	...
	###..............................Функция при старте визуализации сетки..........................### 
	...
	def on_msh_visual_run(par, int_lng, msh_t):
		...
		if int_lng == 'Russian':
			...
			msg_lbl = QLabel('<span style="color:blue">' + "Visualisation of the mesh of type " + msh_t + " started" + '</span>')
	...
	###..............................Функция при завершении визуализации сетки..........................### 
	...
	def on_msh_visual_finished(return_code, prj_path_val_th, mesh_name_txt_val_th, par, int_lng, msh_t):
		...
		if int_lng == 'Russian':
			...
			par.outf_lbl.setText('Visualization results of mesh of type ' + msh_t) 
		par.cdw.setWidget(par.outf_scroll)
		par.cdw.setTitleBarWidget(par.cdw_frame)
		par.outf_edit.setText(data)
		...
		if return_code == 0:
			if int_lng == 'Russian':
				...
				msg_lbl = QLabel('<span style="color:green">' + "Mesh visualisation of type " + msh_t + " completed" + '</span>')
			color = QtGui.QColor("green")
			...
			if int_lng == 'Russian':
				...
				msg_lbl = QLabel('<span style="color:red">' + "Mesh visualisation of type " + msh_t + " completed with errors" + '</span>')
			color = QtGui.QColor("red")
